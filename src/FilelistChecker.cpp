...
const struct CheckItem supplied_basic_check[] = {
    {"data/tmapa007.dat",CIF_Default,{0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00} },
    {"ldata/dkmap01.raw",CIF_Default,{0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00} },
    {"sound/sound.dat",CIF_Default,{0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00} },
    {"keeperfx.exe",CIF_Default,{0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00} },
...
const struct CheckItem additional_basic_check[] = {
    {"data/creature.jty",CIF_Default,{0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00} },
    {"ldata/front.raw",CIF_Default,{0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00} },
    {"sound/atmos2.sbk",CIF_Default,{0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00} },
    {"keeperfx.exe",CIF_Default,{0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00} },
    {NULL,CIF_Default,{0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00} },
};
...
bool FilelistChecker::verifyList(const struct CheckItem *ciList)
{
...
int FilelistChecker::verifyItem(const struct CheckItem &cItem)
{
    try {
        if (!fileExists(cItem.filename,false,false))
            return CIR_NotFound;
    }
    catch (std::exception &e) {
        wxLogMessage(wxT("Error while checking \"%s\": %s"),cItem.filename,e.what());
 ...
 * @return
 */
bool FilelistChecker::fileExists(const char * filename, bool acceptFolders, bool acceptSpecial)
{
  struct stat fileInfo;
  int statRet;

  // Attempt to get the file attributes
  statRet = stat(filename,&fileInfo);
  if(statRet == 0) {
...
const char * FilelistChecker::getFailedFilename(int idx)
{
